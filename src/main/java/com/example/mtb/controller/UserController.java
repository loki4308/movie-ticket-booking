...
public class UserController {
    ...
    public ResponseEntity<ResponseStructure<UserResponse>> registerUser(@RequestBody UserRegistrationRequest request) {
    ...
    @PutMapping("/users")
    public ResponseEntity<ResponseStructure<UserResponse>> updateUser(@RequestBody UserRequest request, @RequestParam String email){
